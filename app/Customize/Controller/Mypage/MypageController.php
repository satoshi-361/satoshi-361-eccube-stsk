...
class MypageController extends AbstractController
{
    ...
    public function login(Request $request, AuthenticationUtils $utils)
    {
        ...
        // print_r(gettype($request->getSession()->get('_security.login_memory')));
        // if ((bool) $request->getSession()->get('_security.login_memory')) print_r('remembered');
        // else print_r('not remembered');
        // exit;
